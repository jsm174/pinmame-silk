    ...
    public class ColorUtil
	{
		...
		public static Color[] GetPalette(Color[] palette, int numColors)
		{
			...
			if (palette.Length == 4 && numColors == 16) {
				return new[] { palette[0], palette[1], Color.Black, Color.Black, palette[2], Color.Black, Color.Black, Color.Black, Color.Black, Color.Black, Color.Black, Color.Black, Color.Black, Color.Black, Color.Black, palette[3] };
			}
		...
		public static Color FromVector3(Vector3 vector3)
		{
			return Color.FromArgb(255,
				(int)(vector3.X * 255), (int)(vector3.Y * 255), (int)(vector3.Z * 255));
		}
		...
		{
			return Color.FromArgb((int)(vector4.W * 255),
				(int)(vector4.X * 255), (int)(vector4.Y * 255), (int)(vector4.Z * 255));
		}
